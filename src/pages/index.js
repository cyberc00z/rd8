    ...
    <Layout location={location} title={siteTitle}>
      ...
      <div className="about_page">
        ...
        <p>
         ...
         <iframe width="100%" height="300" scrolling="no" frameborder="no" allow="autoplay" src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/playlists/664637079&color=%235c4c3c&auto_play=true&hide_related=false&show_comments=true&show_user=true&show_reposts=false&show_teaser=true&visual=true"></iframe><div style="font-size: 10px; color: #cccccc;line-break: anywhere;word-break: normal;overflow: hidden;white-space: nowrap;text-overflow: ellipsis; font-family: Interstate,Lucida Grande,Lucida Sans Unicode,Lucida Sans,Garuda,Verdana,Tahoma,sans-serif;font-weight: 100;"><a href="https://soundcloud.com/azadirecords" title="Azadi Records" target="_blank" style="color: #cccccc; text-decoration: none;">Azadi Records</a> · <a href="https://soundcloud.com/azadirecords/sets/bayaan-seedhe-maut-azadi-records-azr010" title="&#x27;Bayaan&#x27;  | Seedhe Maut | Azadi Records | AZR010" target="_blank" style="color: #cccccc; text-decoration: none;">&#x27;Bayaan&#x27;  | Seedhe Maut | </a></div> 
        <br />
